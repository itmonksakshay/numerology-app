...
const Footer = () => {
  return (
    <footer className=' w-full h-[354px] bg-gradient-0 mt-[-2px] flex flex-col items-center gap-[42px] py-[50px]'>
      <div className="">
        <img src={starIcon} alt='star' />
      </div>
      <div className="text-white font-medium text-[16px]  leading-[19.36px]">
